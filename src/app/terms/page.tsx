      ...
      <main className="bg-white min-h-screen pt-32 pb-24">
        <article className="max-container w-full">
          ...
          <header className="mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-[#111111] tracking-tight mb-8">Zill Terms and Conditions</h1>
          ...
          <div className="text-[#444444] text-[16px] leading-[1.8] space-y-6 w-full">
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">1. About Zill</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">2. Eligibility</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">3. Accounts</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">4. Seller Responsibilities</h2>
            <p>Sellers must:</p>
            <ul className="list-disc pl-6 space-y-2 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">5. Prohibited Activities</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">7. Refunds and Cancellations</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">8. Reviews and User Content</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">9. Intellectual Property</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">10. Account Suspension</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">11. Platform Availability</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">12. Disputes</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">13. Limitation of Liability</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">14. Changes to These Terms</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">15. Governing Law</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] mt-12 mb-6">16. Contact</h2>
