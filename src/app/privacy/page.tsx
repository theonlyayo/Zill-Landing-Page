    ...
    <>
      <main className="bg-white dark:bg-[#000000] min-h-screen pt-32 pb-24">
        <article className="max-container w-full">
          <Link href="/" className="inline-flex items-center gap-2 text-[14px] text-[#666666] dark:text-[#666666] hover:text-[#111111] dark:hover:text-[#FFFFFF] mb-12 transition-colors group">
          ...
          <header className="mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-[#111111] dark:text-white tracking-tight mb-8">Zill Privacy Policy</h1>
          ...
          <div className="text-[#444444] text-[16px] leading-[1.8] space-y-6 w-full">
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">1. Information We Collect</h2>
            <p>Depending on how you use Zill, we may collect the following categories of information:</p>
            
            <h3 className="text-xl font-semibold text-[#111111] dark:text-white mt-8 mb-4">A. Information You Provide</h3>
            ...
            <h3 className="text-xl font-semibold text-[#111111] dark:text-white mt-8 mb-4">B. Transaction Information</h3>
            ...
            <h3 className="text-xl font-semibold text-[#111111] dark:text-white mt-8 mb-4">C. Automatically Collected Information</h3>
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">2. How We Use Your Information</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">3. Legal Basis for Processing</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">4. Information Shared With Other Users</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">5. Service Providers</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">7. Fraud Prevention and Security</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">8. Data Security</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">9. Data Retention</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">10. Your Privacy Rights</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">11. Children&apos;s Privacy</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">12. International Data Transfers</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">13. Marketing Communications</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">14. Cookies and Similar Technologies</h2>
            ...
            <h2 className="text-2xl font-bold text-[#111111] dark:text-white mt-12 mb-6">15. Third-Party Services and Links</h2>
